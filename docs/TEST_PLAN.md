...
| 1.2 | Cold power-on with NO known WiFi in range | Boot screen → retry attempt → WiFi Setup screen with "OffenHerz-Setup" and "192.168.4.1" |
...
| 3.2 | Connect phone to "OffenHerz-Setup" (open, no password) | Phone joins network |
...
| 3.5 | Submit valid credentials | "Saved! OffenHerz is restarting…" shown in browser; device reboots |
